...
enum StatusTransaksi: string
{
    ...
    {
        return match($this) {
            StatusTransaksi::Menunggu   => 'Menunggu Pembayaran',
    ...
    {
        return match($this) {
            StatusTransaksi::Menunggu   => 'bg-semantic-warning/10 text-semantic-warning border border-semantic-warning/30',
            StatusTransaksi::Diproses   => 'bg-semantic-info/10 text-semantic-info border border-semantic-info/30',
            StatusTransaksi::Selesai    => 'bg-semantic-success/10 text-semantic-success border border-semantic-success/30',
            StatusTransaksi::Dibatalkan => 'bg-semantic-danger/10 text-semantic-danger border border-semantic-danger/30',
        };
    }
    ...
    {
        return match($this) {
            StatusTransaksi::Menunggu   => [StatusTransaksi::Diproses, StatusTransaksi::Dibatalkan],
            StatusTransaksi::Diproses   => [StatusTransaksi::Selesai, StatusTransaksi::Dibatalkan],
